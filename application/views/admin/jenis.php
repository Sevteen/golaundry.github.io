            ...
            <div class="col-sm-9">
              <div class="form-group clearfix">
                <div class="icheck-primary d-inline">
                  <input type="radio" class="statusbiaya" id="statusbiaya1" name="statusbiaya" value="kg" checked>
                  <label for="statusbiaya1">Per Kilo
                  </label>
                </div>
                <div class="icheck-primary d-inline">
                  <input type="radio" class="statusbiaya" id="statusbiaya2" value="pcs" name="statusbiaya">
