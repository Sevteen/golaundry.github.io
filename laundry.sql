...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Des 2021 pada 05.48
...
CREATE TABLE `jenispakaian` (
  ...
  `statusbiaya` enum('kg','pcs') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Pakaian Biasa', 15000, 'kg'),
(2, 'Selimut', 25000, 'kg'),
(3, 'Bad Cover', 50000, 'kg'),
(4, 'Cuci Komplit', 10000, 'kg'),
(5, 'Setrika', 4000, 'kg'),
(6, 'Gordyn', 15000, 'kg'),
(7, 'Bantal Kecil', 20000, 'pcs'),
(8, 'Bantal Besar', 55000, 'pcs'),
(9, 'Bed Cover Double', 35000, 'pcs'),
(10, 'Bed Cover Single', 25000, 'pcs'),
(11, 'Blouse', 15000, 'pcs'),
(12, 'Jas', 25000, 'pcs'),
(13, 'Jacket Parasut', 25000, 'pcs'),
(14, 'Jacket Jeans ', 20000, 'pcs'),
(15, 'Guling', 70000, 'pcs'),
(16, 'Sepatu', 50000, 'pcs'),
(17, 'Tas', 50000, 'pcs'),
(18, 'Cuci Express', 20000, 'kg'),
(19, 'Boneka Kecil', 10000, 'pcs'),
(20, 'Boneka Besar', 25000, 'pcs');
...
INSERT INTO `pelanggan` (`kd_pelanggan`, `nama`, `alamat`, `no_hp`, `email`, `jk`, `iduser`) VALUES
(1, 'Ilham Hanif', 'Perum. Cibarusah Indah Blok C4 No 19', '081586308435', 'ilhamhanif07@gmail.com', 'Pria', 2);
...
CREATE TABLE `pemesanan` (
  ...
  `kd_pelanggan` int(11) NOT NULL,
  `status` enum('Booking','Jemput','Proses','Selesai','Antar','Batal') DEFAULT 'Booking',
  `update_at` datetime NOT NULL,
  `pick_up_delivery` enum('1','0') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'GoLaundry', 'Kab Bekasi ses', '081586308435');
...
(2, 'ilhamhanif07', '373ae0f5e470162374c76be51f5f46ae', 'Member');
...
--
ALTER TABLE `detailpemesanan`
  MODIFY `iddetailpemesanan` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `jenispakaian`
--
ALTER TABLE `jenispakaian`
  MODIFY `idjenispakaian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `pelanggan`
  MODIFY `kd_pelanggan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
